            ...
            <nav className="navbar navbar-expand-lg bg-dark bg-body-tertiary ">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <Link className="nav-link active mx-3" aria-current="page" to="/announcement">
                                    Announcements
                                </Link>
                            </li>
                ...
                {user ? (
                    <div className=" d-flex align-items-center gap-3">
                        <button onClick={() => navigate("/profile")} className="  w-75 h-75">
                            <img src="./Images/profile.png" width={35} alt="profile" />
                        </button>
