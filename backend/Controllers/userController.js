...
module.exports.fetchTrainingDetails = async (req, res, next) => {
    try {
        ...
        res.json({
            message: "Training class fetched",
            status: true,
        ...
        console.log(error);
        res.json({
            message: "Internal server error in fetch training class ",
            status: false,
        });
    }
};
...
module.exports.fetchAcademicDetails = async (req, res, next) => {
    try {
        ...
        res.json({
            message: "Academic class fetched",
            status: true,
        ...
        console.log(error);
        res.json({
            message: "Internal server error in fetch academic details",
            status: false,
        });
    }
};
...
module.exports.sendDonationReq = async (req, res, next) => {
    try {
        ...
        console.log(error);
        res.json({
            message: "Internal server error in donation request",
            status: false,
        });
    }
};
...
module.exports.userApprovedDonation = async (req, res, next) => {
    try {
        ...
        const approvedDonation = await donationModel.find({
            ownerId: userId,
            Verified: true,
        });
        return res.json({
            message: "fetch approved donation",
            status: true,
        ...
        console.log(error);
        res.json({
            message: "Internal server error in fetching approved donation",
            status: false,
        });
    }
};
